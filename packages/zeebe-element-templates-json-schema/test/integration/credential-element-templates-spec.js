...
// credential-enabled connector element templates exercising the `Configuration`
// property type and embedded `configurationTemplates`
const templates = require('./credential-element-templates.json');
