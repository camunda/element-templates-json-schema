...
export const errors = [
  {
    ...
    dataPath: '/properties',
    schemaPath: '#/allOf/1/allOf/12/allOf/0/then/properties/properties/errorMessage',
    params: {
      errors: [
        {
          keyword: 'not',
          dataPath: '/properties',
          schemaPath: '#/allOf/1/allOf/12/allOf/0/then/properties/properties/not',
          params: {},
  ...
  },
  {
    keyword: 'if',
    dataPath: '',
    schemaPath: '#/allOf/1/allOf/12/allOf/0/if',
    params: {
      failingKeyword: 'then'
    },
