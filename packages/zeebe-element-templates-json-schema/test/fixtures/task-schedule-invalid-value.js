...
export const errors = [
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/28/then/properties/value/errorMessage',
    params: {
      errors: [
        {
          keyword: 'pattern',
          dataPath: '/properties/1/value',
          schemaPath: '#/allOf/1/items/allOf/28/then/properties/value/pattern',
          params: {
  ...
  },
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/28/if',
    params: {
      failingKeyword: 'then'
    },
