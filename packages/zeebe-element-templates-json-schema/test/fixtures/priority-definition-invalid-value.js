...
export const errors = [
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/24/then/properties/value/minimum',
    params: {
      comparison: '>=',
      limit: 0
    },
  ...
  },
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/24/if',
    params: {
      failingKeyword: 'then'
    },
  ...
  },
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/24/then/properties/value/maximum',
    params: {
      comparison: '<=',
      limit: 100
    },
  ...
  },
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/25/then/properties/value/errorMessage',
    params: {
      errors: [
        {
          keyword: 'pattern',
          dataPath: '/properties/3/value',
          schemaPath: '#/allOf/1/items/allOf/25/then/properties/value/pattern',
          params: {
            pattern: '^(100|[1-9]?[0-9])$'
          },
  ...
  },
  {
    ...
    schemaPath: '#/allOf/1/items/allOf/26/then/properties/choices/items/allOf/1/properties/value/errorMessage',
    params: {
      errors: [
        {
          keyword: 'pattern',
          dataPath: '/properties/5/choices/0/value',
          schemaPath: '#/allOf/1/items/allOf/26/then/properties/choices/items/allOf/1/properties/value/pattern',
          params: {
            pattern: '^(100|[1-9]?[0-9])$'
          },
          message: 'should match pattern "^(100|[1-9]?[0-9])$"',
