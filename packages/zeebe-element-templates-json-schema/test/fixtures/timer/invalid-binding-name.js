export const template = {
  name: 'TimerInvalidBindingName',
  id: 'com.camunda.example.TimerInvalidBindingName',
  appliesTo: [
    'bpmn:StartEvent'
  ],
  elementType: {
...
export const errors = [
  ...
  },
  {
    keyword: 'enum',
    dataPath: '/properties/0/binding/name',
    schemaPath: '#/allOf/1/items/properties/binding/allOf/14/then/properties/name/enum',
    params: {
      allowedValues: [
        'timeCycle',
        'timeDate',
  ...
  },
  {
    ...
    schemaPath: '#/allOf/1/items/properties/binding/allOf/14/if',
    params: {
      failingKeyword: 'then'
    },
    message: 'should match "then" schema'
