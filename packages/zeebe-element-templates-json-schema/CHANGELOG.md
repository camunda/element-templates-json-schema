...
* `FEAT`: support `configurationTemplateVersion` minimum version floor on `Configuration` properties
...
* `FEAT`: allow `entriesVisible` to accept an object with property group ids to show them in properties panel with applied template ([#218](https://github.com/camunda/element-templates-json-schema/pull/218))

## 0.36.0

* `FEAT`: support templating conditional events ([#212](https://github.com/camunda/element-templates-json-schema/pull/212))
...
* `FEAT`: disallow `bpmn:cancelRemainingInstances`, `bpmn:completionCondition` and `zeebe:activeElementsCollection` when `zeebe:taskDefinition` present ([#194](https://github.com/camunda/element-templates-json-schema/pull/194))
